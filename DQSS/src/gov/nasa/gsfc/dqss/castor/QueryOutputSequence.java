 ...
 * Schema.
 * $Id: QueryOutputSequence.java,v 1.2 2010/11/10 17:59:46 rstrub Exp $
 */

package gov.nasa.gsfc.dqss.castor;

/**
 * Class QueryOutputSequence.
 * 
 * @version $Revision: 1.2 $ $Date: 2010/11/10 17:59:46 $
 */
@SuppressWarnings("serial")
public class QueryOutputSequence implements java.io.Serializable {
     ...
     * gov.nasa.gsfc.dqss.castor.QueryOutputSequence
     */
    public static gov.nasa.gsfc.dqss.castor.QueryOutputSequence unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (gov.nasa.gsfc.dqss.castor.QueryOutputSequence) org.exolab.castor.xml.Unmarshaller.unmarshal(gov.nasa.gsfc.dqss.castor.QueryOutputSequence.class, reader);
    }
