...
/**
 * Class ValidQualityLevel.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ValidQualityLevel implements java.io.Serializable {
     ...
     * gov.nasa.gsfc.dqss.castor.expression.ValidQualityLevel
     */
    public static gov.nasa.gsfc.dqss.castor.expression.ValidQualityLevel unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (gov.nasa.gsfc.dqss.castor.expression.ValidQualityLevel) org.exolab.castor.xml.Unmarshaller.unmarshal(gov.nasa.gsfc.dqss.castor.expression.ValidQualityLevel.class, reader);
    }
