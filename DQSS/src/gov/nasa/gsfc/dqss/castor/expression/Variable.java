...
public class Variable implements java.io.Serializable {
     ...
     * gov.nasa.gsfc.dqss.castor.expression.Variable
     */
    public static gov.nasa.gsfc.dqss.castor.expression.Variable unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (gov.nasa.gsfc.dqss.castor.expression.Variable) org.exolab.castor.xml.Unmarshaller.unmarshal(gov.nasa.gsfc.dqss.castor.expression.Variable.class, reader);
    }
