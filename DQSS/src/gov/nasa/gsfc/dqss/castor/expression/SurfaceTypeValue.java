...
/**
 * Class SurfaceTypeValue.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SurfaceTypeValue implements java.io.Serializable {
     ...
     * gov.nasa.gsfc.dqss.castor.expression.SurfaceTypeValue
     */
    public static gov.nasa.gsfc.dqss.castor.expression.SurfaceTypeValue unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (gov.nasa.gsfc.dqss.castor.expression.SurfaceTypeValue) org.exolab.castor.xml.Unmarshaller.unmarshal(gov.nasa.gsfc.dqss.castor.expression.SurfaceTypeValue.class, reader);
    }
